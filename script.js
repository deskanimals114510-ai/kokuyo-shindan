...
const DAY_MASTER_TYPES = {
  0: { // 甲
    ...
    relationships: '人間関係では、裏表のないまっすぐな付き合い方をするから、下心のない人だと信頼されやすいタイプ。ただし、自分の正しさを押し付けがちだから、相手の弱さも受け止める余裕を持ちなさい。広く浅くより、少数と深く付き合う方が性に合っているはずよ。',
  ...
  1: { // 乙
    ...
    relationships: '人間関係では、誰とでも波風立てずにやっていける器用さがあるタイプ。ただ、自分を後回しにして合わせてばかりいると、都合のいい人で終わってしまう。本音を出しても大丈夫な相手を、意識して選びなさい。',
  ...
  2: { // 丙
    ...
    relationships: '人間関係では、輪の中心にいることが多いタイプ。誰とでもすぐ打ち解けるけれど、広く浅くになりがちで、深く付き合う前に興味が移ってしまうこともある。本当に大事にしたい相手には、意識して時間をかけなさい。',
  ...
  3: { // 丁
    ...
    relationships: '人間関係では、広く浅くより、少数の相手と深く付き合うタイプ。心を開くまでに時間がかかる分、一度信頼した相手には驚くほど誠実よ。無理に社交的に振る舞う必要はないの。',
  ...
  4: { // 戊
    ...
    relationships: '人間関係では、動じない安心感で頼られるタイプ。ただ、自分から歩み寄るのは苦手で、待ちの姿勢になりがち。たまにはこちらから声をかけてみなさい、それだけで関係はもっと深まるはずよ。',
  ...
  5: { // 己
    ...
    relationships: '人間関係では、聞き役・支え役に回ることが多いタイプ。頼られることに喜びを感じる一方、自分の弱音を見せるのが苦手でしょう。たまには弱いところも見せなさい、そのほうが人はあなたに近づきやすくなるのよ。',
  ...
  6: { // 庚
    ...
    relationships: '人間関係では、はっきりものを言うぶん、信頼できる人だと思われやすいタイプ。ただし、その率直さが刃のように相手を傷つけることもある。正しさより思いやりを選ぶ場面も、覚えておきなさい。',
  ...
  7: { // 辛
    ...
    relationships: '人間関係では、選び抜いた少数と深く付き合うタイプ。誰にでも心を開くわけじゃないから、周りからは「近寄りがたい」と思われがちだけど、それでいいのよ。無理に広げる必要はないわ。',
  ...
  8: { // 壬
    ...
    relationships: '人間関係では、誰とでも気さくに話せる社交性があるタイプ。ただ、深入りを避ける癖があって、周りからは「本音が見えない」と思われがちよ。信頼した相手には、もう少し踏み込んでみなさい。',
  ...
  9: { // 癸
    ...
    relationships: '人間関係では、聞き上手で相手の本音を引き出すのが得意なタイプ。ただし、自分のことは語らないから、周りからは謎めいて見られがち。信頼できる相手には、あなたからも心を開いてみなさい。',
